...
if(isset($_POST['employee_id']) && !empty($_POST['employee_id'])) {
    ...
    $filter_condition = "WHERE ed.employee_ID = $employee_id";
}
...
.container_viewdocs {
    ...
    margin-left: 260px; /* Smaller left margin */
...
@media (max-width: 768px) {
    ...
    .container_viewdocs {
        margin-left: 10px; /* Adjust left margin for better spacing on small screens */
        margin-right: 10px; /* Adjust right margin for better spacing on small screens */
    }
    .container_viewdocs select {
